...
export class RAxios {
  ...
  private setupInterceptors() {
    ...
    this.axiosInstance.interceptors.request.use(
      (config: InternalAxiosRequestConfig) => {
        // If cancel repeat request is turned on, the request will ignore the cancel token
  ...
  /**
   * @decription Files Upload
   * @param config 
   * @returns 
  */
  uploadFiles<T = any>(config: AxiosRequestConfig, params: FormData, options?: RequestOptions) {
